...
/**
 *  1st: check if the size is less than 5 MB
 *  2nd: check if the file is image format
 *  3rd: check if the image is a human face
 *
 */
@Service
public class BucketService {
    ...
    public String uploadFile(MultipartFile multipartFile) {
       ...
       Boolean isImage = true;//isImage(multipartFile);
